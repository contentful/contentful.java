...
REPO_SLUG="contentful/contentful.java"
GROUP_PATH="com/contentful/java"   # groupId with slashes
ARTIFACTS="java-sdk"               # artifacts that must appear on Maven Central
TAG_PREFIX="v."                    # tags look like v.10.6.1
MAVEN_ARGS=()                      # extra Maven arguments for the deploy build
# -------------------------------------------------------------------------------------------------
