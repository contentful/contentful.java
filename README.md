...
or Gradle:
```groovy
compile 'com.contentful.java:java-sdk:5.0.0'
```
...
Copyright (c) 2015 Contentful GmbH. See [LICENSE.txt][6] for further details.
 ...
 [2]: https://oss.sonatype.org/service/local/repositories/releases/content/com/contentful/java/java-sdk/5.0.0/java-sdk-5.0.0.jar
