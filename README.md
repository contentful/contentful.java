...
or Gradle:
```groovy
compile 'com.contentful.java:java-sdk:1.0.1'
```
...
Copyright (c) 2014 Contentful GmbH. See LICENSE.txt for further details.
 ...
 [2]: https://oss.sonatype.org/service/local/repositories/releases/content/com/contentful/java/java-sdk/1.0.1/java-sdk-1.0.1.jar
