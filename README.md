...
```groovy
compile 'com.contentful.java:java-sdk:10.2.2'
```
...
implementation 'com.contentful.java:java-sdk:10.2.2-SNAPSHOT'
```
...
implementation 'com.github.contentful:contentful.java:java-sdk-10.2.2-SNAPSHOT'
```
